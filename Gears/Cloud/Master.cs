...
{
    //TODO: Input must be done and implemented, and events could use organization.
    internal static class Master
    {
        ...
        //temp top to list 
        internal static void Push(GameState gameState)
        {
            stack.Push(gameState);
        }
        internal static GameState Peek()
        {
            return stack.Peek();
        }
        internal static GameState Pop()
        {
            return stack.Pop();
        }
        ...
        internal static int GetListLength()
        {
            return list.Count;
        }
        internal static int GetStackLength()
        {
            return stack.Count;
        }
